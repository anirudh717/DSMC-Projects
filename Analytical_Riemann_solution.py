...
style(axs[0],ylabel="Density (kg/m³)",ylim=(-0.05*rho_max, 1.22*rho_max),title="Analytical Riemann Solution at T={:.3e} s".format(t),labelpad=34)  # Adjust this value
